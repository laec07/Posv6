...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.add_stock_transfer') Solicitud</h1>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', $statuses, 'Solicitado', [
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('location_id', $business_locations_all, null, [
                            'class' => 'form-control select2',
